...
import { mockUnits } from './hooks/table-hooks';
import { UnitTable } from './components/unitTable';
import { ReactNode, useState } from 'react';
import { ButtonCreateUnit } from './components/buttonCreateUnit';
import { UseQueryUnitList } from '../common/services/requests/getListsUnit';
  ...
  return (
    <div className="min-h-screen px-8 pt-20 bg-center first-line:bg-center text-ellipsis">
      ...
      <div className="flex justify-between py-8">
        <h1 className="text-4xl font-bold">Gestão de franquias</h1>
        <ButtonCreateUnit />
      </div>
